...
using AOWebAppActivity.Data;
using AOWebAppActivity.Models;

namespace AOWebAppActivity.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemName,ItemDescription,ItemCost,ItemImage,CategoryId")] Item item)
        {
